def problem11():
    ...
    def down():
        ...
        for column in range(20):
            for i in range(17):
                a = numbers[i][column]
                b = numbers[i + 1][column]
                c = numbers[i + 2][column]
                d = numbers[i + 3][column]
                product = a * b * c * d
                if product > largest:
                    largest = product
        return largest

    def diagonally_right():
        largest = 0

        for column in range(17):
            for i in range(17):
                a = numbers[i][column]
                b = numbers[i + 1][column + 1]
                c = numbers[i + 2][column + 2]
                d = numbers[i + 3][column + 3]
                product = a * b * c * d
                if product > largest:
                    largest = product
        return largest
    ...
    products = [right(), down(), diagonally_right(), diagonally_left()]
    largest_product = 0
...
def problem18():
    ...
    for row in triangle:
        if len(row) > 1:
            if int(row[position]) > int(row[position + 1]):
                sum += int(row[position])
            else:
                sum += int(row[position + 1])
                position += 1
        else:
            sum += int(row[0])
